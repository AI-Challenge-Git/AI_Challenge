...
"년/월/일" 대신 하이픈(-)·점(.)·슬래시(/)로 구분된 숫자 날짜 표기도 같은
규칙을 따릅니다. 연도가 두 자리든 네 자리든 위 "2자리 축약 연도"와 동일하게
20YY로 정규화하세요.

원문:
"26-9-28 8시 23분 쯤에 매수 주문을 넣었는데 접수됐는지 확인이 안 됩니다"

reported_occurred_at:
{{"value": "2026-09-28T08:23:00+09:00",
  "status": "CONFIRMED_FROM_TEXT",
  "evidence_quote": "26-9-28 8시 23분"}}

evidence_quote는 원문의 숫자·구분자 표기를 그대로 복사하세요(예: "26-9-28"을
"2026-09-28"로 바꾸지 마세요). value에만 정규화된 4자리 연도를 사용합니다.

슬래시(/)로 구분된 날짜도 동일하게 처리하세요. 시각도 "시/분" 대신
"23:34" 같은 콜론(:) 표기로 올 수 있습니다.

원문:
"26/07/18 23시 34분에 매도 하려고 했는데 최소 주문 수량이 안 맞는다고
거래가 안되네"

reported_occurred_at:
{{"value": "2026-07-18T23:34:00+09:00",
  "status": "CONFIRMED_FROM_TEXT",
  "evidence_quote": "26/07/18 23시 34분에"}}

원문:
"2026/07/18 23:34에 매도 주문을 넣었다"

reported_occurred_at:
{{"value": "2026-07-18T23:34:00+09:00",
  "status": "CONFIRMED_FROM_TEXT",
  "evidence_quote": "2026/07/18 23:34에"}}
